...
\restrict wY51X2Xo1jSARspPlHPhJaU9bM96OYqBqd08Da8XcEdTxbJn6VeuFdqqsUcJ71w
...
BEGIN
    ...
    IF NOT FOUND THEN
        INSERT INTO situacion_actual (unidad_id, icono, actividad_id, actividad_tipo_nombre, actividad_estado, actividad_created_at, estado, km, sentido, ruta_id, ruta_codigo, latitud, longitud, updated_at)
        VALUES (NEW.unidad_id, v_icono, NEW.id, v_nombre_actividad, NEW.estado, NEW.created_at, NEW.estado, NEW.km, NEW.sentido, NEW.ruta_id, v_ruta_codigo, NEW.latitud, NEW.longitud, NOW());
    END IF;
...
--
-- Name: fn_validar_asignacion_sede(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fn_validar_asignacion_sede() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: fn_validar_tripulacion_fecha_unica(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fn_validar_tripulacion_fecha_unica() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  v_fecha DATE;
...
CREATE FUNCTION public.iniciar_salida_unidad(p_unidad_id integer, p_ruta_inicial_id integer, p_km_inicial numeric, p_combustible_inicial numeric, p_observaciones text) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_salida_id INT;
...
CREATE FUNCTION public.validar_disponibilidad_brigada(p_usuario_id integer, p_fecha date) RETURNS TABLE(disponible boolean, mensaje text, dias_descanso integer)
...
CREATE TABLE public.actividad (
    ...
    requiere_infografia boolean DEFAULT false,
...
CREATE TABLE public.autoridad (
    ...
    datos jsonb DEFAULT '{}'::jsonb,
    created_at timestamp with time zone DEFAULT now(),
    categoria character varying(20) DEFAULT 'AUTORIDAD'::character varying,
    CONSTRAINT autoridad_categoria_check CHECK (((categoria)::text = ANY ((ARRAY['AUTORIDAD'::character varying, 'SOCORRO'::character varying])::text[])))
);
...
CREATE TABLE public.aviso_asignacion (
    ...
    creado_por integer NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT aviso_asignacion_tipo_check CHECK (((tipo)::text = ANY ((ARRAY['ADVERTENCIA'::character varying, 'INFO'::character varying, 'URGENTE'::character varying])::text[])))
);
...
CREATE TABLE public.combustible_registro (
    ...
    CONSTRAINT combustible_registro_tipo_check CHECK (((tipo)::text = ANY ((ARRAY['INICIAL'::character varying, 'RECARGA'::character varying, 'FINAL'::character varying, 'AJUSTE'::character varying, 'ABASTECIMIENTO'::character varying])::text[])))
);
...
--
-- Name: delegacion_permiso_cop; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delegacion_permiso_cop (
    id integer NOT NULL,
    otorgado_a integer NOT NULL,
    otorgado_por integer NOT NULL,
    permiso character varying(50) DEFAULT 'GESTIONAR_ACCESO'::character varying NOT NULL,
    activo boolean DEFAULT true NOT NULL,
...
--
-- Name: TABLE delegacion_permiso_cop; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.delegacion_permiso_cop IS 'Permisos temporales de gestion de acceso delegados por ADMIN_COP a operadores de COP';


--
-- Name: delegacion_permiso_cop_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.delegacion_permiso_cop_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: delegacion_permiso_cop_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.delegacion_permiso_cop_id_seq OWNED BY public.delegacion_permiso_cop.id;
...
--
-- Name: dispositivo_blacklist; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.dispositivo_blacklist (
    id integer NOT NULL,
...
--
-- Name: dispositivo_blacklist_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.dispositivo_blacklist_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: dispositivo_blacklist_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.dispositivo_blacklist_id_seq OWNED BY public.dispositivo_blacklist.id;
...
CREATE TABLE public.salida_unidad (
    ...
    sede_origen_id integer,
    inspeccion_360_id integer,
    origen character varying(30) DEFAULT 'APP'::character varying,
    ...
    CONSTRAINT salida_unidad_origen_check CHECK (((origen)::text = ANY ((ARRAY['APP'::character varying, 'COP_EMERGENCIA'::character varying, 'MANUAL'::character varying])::text[])))
);
...
CREATE TABLE public.situacion (
    ...
    CONSTRAINT situacion_clima_check CHECK (((clima IS NULL) OR ((clima)::text = ANY (ARRAY['DESPEJADO'::text, 'NUBLADO'::text, 'LLUVIA'::text, 'NEBLINA'::text, 'TORMENTA'::text, 'SOLEADO'::text])))),
    CONSTRAINT situacion_estado_check CHECK (((estado)::text = ANY ((ARRAY['ACTIVA'::character varying, 'CERRADA'::character varying, 'CANCELADA'::character varying, 'EN_PAUSA'::character varying, 'FINALIZADA'::character varying])::text[]))),
    CONSTRAINT situacion_importancia_check CHECK (((importancia IS NULL) OR ((importancia)::text = ANY ((ARRAY['BAJA'::character varying, 'NORMAL'::character varying, 'ALTA'::character varying, 'CRITICA'::character varying])::text[])))),
...
--
-- Name: COLUMN situacion.draft_created_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.situacion.draft_created_at IS 'Timestamp en que se creó el draft en la app móvil. NULL si fue creado desde el panel web.';
...
CREATE TABLE public.situacion_multimedia (
    ...
    CONSTRAINT chk_multimedia_ref CHECK (((draft_uuid IS NOT NULL) OR (situacion_id IS NOT NULL) OR (actividad_id IS NOT NULL))),
...
--
-- Name: situacion_persistente_asignacion; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.situacion_persistente_asignacion (
    id integer NOT NULL,
    situacion_id integer NOT NULL,
    unidad_id integer NOT NULL,
...
--
-- Name: situacion_persistente_asignacion_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.situacion_persistente_asignacion_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: situacion_persistente_asignacion_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.situacion_persistente_asignacion_id_seq OWNED BY public.situacion_persistente_asignacion.id;
...
CREATE VIEW public.v_estadisticas_unidades AS
 WITH turnos_stats AS (
         SELECT au.unidad_id,
            count(
                CASE
                    WHEN (t.fecha >= (CURRENT_DATE - 30)) THEN 1
                    ELSE NULL::integer
                END) AS turnos_ultimo_mes,
            count(
                CASE
                    WHEN (t.fecha >= (CURRENT_DATE - 90)) THEN 1
                    ELSE NULL::integer
                END) AS turnos_ultimo_trimestre,
            max(t.fecha) AS ultimo_turno_fecha,
            min(
                CASE
                    WHEN (t.fecha > CURRENT_DATE) THEN t.fecha
                    ELSE NULL::date
                END) AS proximo_turno_fecha
           FROM (public.asignacion_unidad au
             JOIN public.turno t ON ((au.turno_id = t.id)))
          GROUP BY au.unidad_id
        ), km_stats AS (
         SELECT combustible_registro.unidad_id,
            sum(combustible_registro.km_recorridos) AS km_ultimo_mes
           FROM public.combustible_registro
          WHERE ((combustible_registro.created_at >= (now() - '30 days'::interval)) AND (combustible_registro.km_recorridos IS NOT NULL))
 ...
 SELECT u.id AS unidad_id,
   ...
   FROM ((((public.unidad u
     ...
     LEFT JOIN public.unidad_reparacion rep ON (((rep.unidad_id = u.id) AND ((rep.estado)::text = 'EN_REPARACION'::text))));
...
--
-- Name: delegacion_permiso_cop id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegacion_permiso_cop ALTER COLUMN id SET DEFAULT nextval('public.delegacion_permiso_cop_id_seq'::regclass);
...
--
-- Name: dispositivo_blacklist id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispositivo_blacklist ALTER COLUMN id SET DEFAULT nextval('public.dispositivo_blacklist_id_seq'::regclass);
...
--
-- Name: situacion_persistente_asignacion id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.situacion_persistente_asignacion ALTER COLUMN id SET DEFAULT nextval('public.situacion_persistente_asignacion_id_seq'::regclass);
...
--
-- Name: delegacion_permiso_cop delegacion_permiso_cop_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegacion_permiso_cop
    ADD CONSTRAINT delegacion_permiso_cop_pkey PRIMARY KEY (id);
...
--
-- Name: dispositivo_blacklist dispositivo_blacklist_clave_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispositivo_blacklist
    ADD CONSTRAINT dispositivo_blacklist_clave_key UNIQUE (clave);


--
-- Name: dispositivo_blacklist dispositivo_blacklist_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dispositivo_blacklist
    ADD CONSTRAINT dispositivo_blacklist_pkey PRIMARY KEY (id);
...
--
-- Name: situacion_persistente_asignacion situacion_persistente_asignacion_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.situacion_persistente_asignacion
    ADD CONSTRAINT situacion_persistente_asignacion_pkey PRIMARY KEY (id);
...
--
-- Name: tarjeta_circulacion tarjeta_circulacion_vehiculo_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tarjeta_circulacion
    ADD CONSTRAINT tarjeta_circulacion_vehiculo_id_unique UNIQUE (vehiculo_id);
...
--
-- Name: idx_aviso_asignacion_asignacion; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_aviso_asignacion_asignacion ON public.aviso_asignacion USING btree (asignacion_id);
...
--
-- Name: idx_delegacion_otorgado_a; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_delegacion_otorgado_a ON public.delegacion_permiso_cop USING btree (otorgado_a) WHERE (activo = true);
...
--
-- Name: idx_multimedia_actividad; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_multimedia_actividad ON public.situacion_multimedia USING btree (actividad_id);
...
--
-- Name: idx_salida_unidad_origen; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_salida_unidad_origen ON public.salida_unidad USING btree (origen);
...
--
-- Name: idx_situacion_persistente; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_situacion_persistente ON public.situacion USING btree (estado) WHERE (persistente = true);
...
--
-- Name: idx_spa_activa; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_spa_activa ON public.situacion_persistente_asignacion USING btree (situacion_id) WHERE (fecha_hora_desasignacion IS NULL);


--
-- Name: idx_spa_situacion; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_spa_situacion ON public.situacion_persistente_asignacion USING btree (situacion_id);
...
--
-- Name: idx_usuario_chapa_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_usuario_chapa_trgm ON public.usuario USING gin (chapa public.gin_trgm_ops);
...
--
-- Name: idx_usuario_nombre_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_usuario_nombre_trgm ON public.usuario USING gin (nombre_completo public.gin_trgm_ops);
...
--
-- Name: uq_actividad_infografia_tipo_orden; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_actividad_infografia_tipo_orden ON public.situacion_multimedia USING btree (actividad_id, infografia_numero, tipo, orden) WHERE (actividad_id IS NOT NULL);


--
-- Name: uq_situacion_infografia_tipo_orden; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_situacion_infografia_tipo_orden ON public.situacion_multimedia USING btree (situacion_id, infografia_numero, tipo, orden) WHERE (situacion_id IS NOT NULL);
...
--
-- Name: uq_turno_fecha_sede; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_turno_fecha_sede ON public.turno USING btree (fecha, sede_id);
...
--
-- Name: asignacion_unidad trg_validar_asignacion_sede; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_validar_asignacion_sede BEFORE INSERT OR UPDATE OF unidad_id, turno_id ON public.asignacion_unidad FOR EACH ROW EXECUTE FUNCTION public.fn_validar_asignacion_sede();
...
--
-- Name: tripulacion_turno trg_validar_tripulacion_fecha_unica; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_validar_tripulacion_fecha_unica BEFORE INSERT ON public.tripulacion_turno FOR EACH ROW EXECUTE FUNCTION public.fn_validar_tripulacion_fecha_unica();
...
--
-- Name: delegacion_permiso_cop delegacion_permiso_cop_otorgado_a_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegacion_permiso_cop
    ADD CONSTRAINT delegacion_permiso_cop_otorgado_a_fkey FOREIGN KEY (otorgado_a) REFERENCES public.usuario(id) ON DELETE CASCADE;


--
-- Name: delegacion_permiso_cop delegacion_permiso_cop_otorgado_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegacion_permiso_cop
    ADD CONSTRAINT delegacion_permiso_cop_otorgado_por_fkey FOREIGN KEY (otorgado_por) REFERENCES public.usuario(id);


--
-- Name: delegacion_permiso_cop delegacion_permiso_cop_revocado_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delegacion_permiso_cop
    ADD CONSTRAINT delegacion_permiso_cop_revocado_por_fkey FOREIGN KEY (revocado_por) REFERENCES public.usuario(id);
...
--
-- Name: situacion_multimedia situacion_multimedia_actividad_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.situacion_multimedia
    ADD CONSTRAINT situacion_multimedia_actividad_id_fkey FOREIGN KEY (actividad_id) REFERENCES public.actividad(id) ON DELETE CASCADE;
...
--
-- Name: situacion_persistente_asignacion situacion_persistente_asignacion_asignacion_unidad_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.situacion_persistente_asignacion
    ADD CONSTRAINT situacion_persistente_asignacion_asignacion_unidad_id_fkey FOREIGN KEY (asignacion_unidad_id) REFERENCES public.asignacion_unidad(id);


--
-- Name: situacion_persistente_asignacion situacion_persistente_asignacion_asignado_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.situacion_persistente_asignacion
    ADD CONSTRAINT situacion_persistente_asignacion_asignado_por_fkey FOREIGN KEY (asignado_por) REFERENCES public.usuario(id);


--
-- Name: situacion_persistente_asignacion situacion_persistente_asignacion_situacion_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.situacion_persistente_asignacion
    ADD CONSTRAINT situacion_persistente_asignacion_situacion_id_fkey FOREIGN KEY (situacion_id) REFERENCES public.situacion(id) ON DELETE CASCADE;


--
-- Name: situacion_persistente_asignacion situacion_persistente_asignacion_unidad_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.situacion_persistente_asignacion
    ADD CONSTRAINT situacion_persistente_asignacion_unidad_id_fkey FOREIGN KEY (unidad_id) REFERENCES public.unidad(id);


--
-- Name: situacion situacion_promovido_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.situacion
    ADD CONSTRAINT situacion_promovido_por_fkey FOREIGN KEY (promovido_por) REFERENCES public.usuario(id);
...
\unrestrict wY51X2Xo1jSARspPlHPhJaU9bM96OYqBqd08Da8XcEdTxbJn6VeuFdqqsUcJ71w

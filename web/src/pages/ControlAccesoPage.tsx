...
export default function ControlAccesoPage() {
  ...
  const getGrupoColor = (grupo: number | null) => {
    if (grupo === null) return 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300';
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">Control de Acceso</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400">Gestiona el acceso a la aplicacion movil</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <ThemeToggle />
            <button onClick={() => refetch()} className="p-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700/50 rounded-lg" title="Actualizar">
        ...
        <>
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Con acceso a app</p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                <p className="text-2xl font-bold text-red-600">{stats.sinAcceso}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">Sin acceso a app</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div className="relative md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400"
                  />
                </div>
                <select
                  value={sedeFilter}
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-gray-700 dark:text-gray-300">Solo sin acceso</span>
                </label>
              </div>
              ...
              {usuariosFiltrados.length > 0 && (
                <div className="flex gap-2 mt-4 pt-4 border-t dark:border-gray-700">
                  <button
                    ...
                    className="px-3 py-1.5 bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-400 rounded-lg text-sm hover:bg-green-200 dark:hover:bg-green-900/60 flex items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-400 rounded-lg text-sm hover:bg-red-200 dark:hover:bg-red-900/60 flex items-center gap-1"
                  >
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50 dark:bg-gray-700 border-b dark:border-gray-600">
                      <tr>
                        ...
                        <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Grupo</th>
                        <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Rol</th>
                        <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Acceso App</th>
                      </tr>
                    </thead>
                      ...
                      {usuariosFiltrados.map((usuario: Usuario) => (
                        <tr key={usuario.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                          <td className="px-4 py-3">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">Chapa: {usuario.chapa}</p>
                          </td>
                          <td className="px-4 py-3">
                            <span className="text-sm text-gray-700 dark:text-gray-300">{usuario.sede_nombre || 'Sin sede'}</span>
                          </td>
                          ...
                          <td className="px-4 py-3 text-center">
                            <span className="text-xs text-gray-600 dark:text-gray-400">{usuario.rol_codigo}</span>
                          </td>
                          <td className="px-4 py-3 text-center">
                            <button
